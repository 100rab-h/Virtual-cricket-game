...
void Game::displayMatchSummary() {
	...
	cout << teamA.name << " " << teamA.totalRunsScored << " -" << teamA.wicketsLost << " (" << teamA.totalBallsBowled << ")\n";
	cout << "=================================================\n";
	...
	for (int i = 0; i < playersPerTeam; i++) {
		cout << "| [" << i << "] " << teamA.players[i].name << "\t\t" << teamA.players[i].runsScored << "(" << teamA.players[i].ballsPlayed << ")\t\t"
			<< teamA.players[i].ballsBowled << "-" << teamA.players[i].runsGiven << "-" << teamA.players[i].wicketsTaken << "  |\n";
		cout << "|-----------------------------------------------|\n";
	}
	cout << endl;
	cout << teamB.name << " " << teamB.totalRunsScored << " -" << teamB.wicketsLost << " (" << teamB.totalBallsBowled << ")\n";
	cout << "=================================================\n";
	cout << "| PLAYER\t\tBATTING\t\tBOWLING |\n";
	cout << "=================================================\n";
	...
	for (int i = 0; i < playersPerTeam; i++) {
		cout << "| [" << i << "] " << teamB.players[i].name << "\t\t" << teamB.players[i].runsScored << "(" << teamB.players[i].ballsPlayed << ")\t\t"
			<< teamB.players[i].ballsBowled << "-" << teamB.players[i].runsGiven << "-" << teamB.players[i].wicketsTaken << "  |\n";
		cout << "|-----------------------------------------------|\n";
	}
}